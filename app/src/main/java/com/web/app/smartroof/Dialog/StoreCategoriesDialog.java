...
public class StoreCategoriesDialog extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.bottom_sheet_store_categories, container, false);
        imageView=root.findViewById(R.id.image_view_finish_dialog_market);
        ...
        recyclerViewCycleHome = root.findViewById(R.id.store_categories_list);
        ...
        call.enqueue(new Callback<ArrayList<Category>>() {
            ...
            public void onResponse(Call<ArrayList<Category>> call, Response<ArrayList<Category>> response) {
                ...
                AdapterRecMarketCategory adapterRecyclerviewCycleHome = new AdapterRecMarketCategory(getContext(),categories);
